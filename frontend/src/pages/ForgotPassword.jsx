...
const ForgotPassword = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Option 1: Use the forgotPassword method from AuthContext
      const result = await makeRequest(() => forgotPassword(email));

      // Option 2: Or use your api service directly
      // const result = await makeRequest(() => api.post('/auth/forgot-password', { email }));
